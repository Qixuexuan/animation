...
exports.myKeyFrame = core_1.trigger('myKeyFrame', [
    ...
    core_1.transition('void=>*', [core_1.animate('2000ms 1000ms ease-in', core_1.keyframes([
            core_1.style({ opacity: 0, background: 'yellow', transform: 'translateX(-100%)', offset: 0 }),
            core_1.style({ opacity: .6, background: 'green', transform: 'translateX(150px)', offset: 0.5 }),
...
exports.buttonState = core_1.trigger('buttonState', [
    ...
    core_1.transition('*=>btn_out', core_1.animate('500ms 40ms ease-in-out')),
...
//动画组，多个动画同时进行
exports.groupA = core_1.trigger('group', [
    core_1.transition('void=>*', [core_1.style({ width: 10, Transform: 'translateX(50px)', opacity: 0 }),
        core_1.group([core_1.animate('2s 0.1s ease-in', core_1.style({
                transform: 'translateX(100px)',
                width: 320
            })),
            core_1.animate('0.8s ease', core_1.style({
                opacity: 1
            }))])
    ])
]);
